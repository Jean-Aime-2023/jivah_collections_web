...
const ProductClass: React.FC<ProductClassProps> = ({
  ...
  return (
    <div className="flex flex-col gap-6 text-base">
      ...
      {/* Title */}
      <h4 className="text-4xl tracking-wide font-semibold max-md:text-center max-md:text-2xl">
        {title}
      </h4>
      ...
      <div className="grid lg:grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-6">
        {limitedProducts.map((product) => (
          <div
            ...
            key={product.id}
            className="group bg-white/95 max-md:mx-3 max-md:my-2 border flex rounded-3xl flex-col gap-1 items-center justify-center text-lg relative cursor-pointer hover:scale-105 transition-transform duration-200 hover:shadow"
          >
            ...
            <div className="w-96 p-5 max-md:w-[90%]">
              ...
              <div className="w-full flex items-center justify-between">
                <p className="font-bold text-2xl max-md:text-lg">$ {product.price}</p>
